...
const Home = props => {
  ...
  const title = props.title,
        description = props.description; // 2. Default values will change after they qill be queried
  ...
  const _useState = useState({
    ...
    description: description
        ...
        setSiteInfo = _useState2[1]; // 3. Run the query


  const _useQuery = Object(_hooks__WEBPACK_IMPORTED_MODULE_8__["useQuery"])(query),
        data = _useQuery.data; // 4. When results ready update the default values


  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
    if (data.generalSettings) {
      const _data$generalSettings = data.generalSettings,
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_Reset__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    __self: undefined
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(SiteInfo, {
    title: title,
    description: description,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=main.b0e76965.chunk.js.map