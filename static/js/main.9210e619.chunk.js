...
const Props = {
  ...
  siteDescription: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.string,
...
const query = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject()); // Get site info

const getSiteInfo = data => {
  console.log("data:" + Object(flatted__WEBPACK_IMPORTED_MODULE_6__["stringify"])(data));
};

const Home = props => {
  // Get the default site info
  const siteTitle = props.siteTitle,
        siteDescription = props.siteDescription; // Query the site info

  const _useQuery = Object(_hooks__WEBPACK_IMPORTED_MODULE_7__["useQuery"])(query),
        data = _useQuery.data; // Use the site info


  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {}); //let { title, description } = getSiteInfo(data);

  console.log("data:" + Object(flatted__WEBPACK_IMPORTED_MODULE_6__["stringify"])(data));
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Reset__WEBPACK_IMPORTED_MODULE_8__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58
    },
    __self: undefined
  }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_TypographicGrid__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    __self: undefined
  }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_helmet__WEBPACK_IMPORTED_MODULE_5__["Helmet"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 66
    },
    ...
    __self: undefined
  }, siteTitle), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("meta", {
    name: "description",
...
//# sourceMappingURL=main.9210e619.chunk.js.map