...
const Home = props => {
  ...
  // - Throughout the entire code we pass the same structure: `useState(props)`, `setSiteInfo(data.generalSettings)`, `<SiteInfo {...siteInfo} />` and we decompose only when it is displayed in the `SiteInfo` component
...
//# sourceMappingURL=main.307c4010.chunk.js.map