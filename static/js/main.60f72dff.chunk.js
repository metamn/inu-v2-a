...
const Home = props => {
  ...
  const title = props.title,
        description = props.description; // 2. Default values will change after they will be queried from the database
  // ... So we save them in a status variable which later will be updated
  ...
  const _useQuery = Object(_hooks__WEBPACK_IMPORTED_MODULE_8__["useQuery"])(query),
        data = _useQuery.data; // 4. When results ready update the status variable
...
//# sourceMappingURL=main.60f72dff.chunk.js.map